...
pub fn query_test_for_swissprot(env: AppArgs) {
    match env {
        AppArgs::Test {
            ...
            let result = index_table.query_multiple_with_count(&queries_u64, 2);
            ...
            let answer = vec![
                "P10144","Q06605","P11032","P12544","Q7YRZ7","P04187","P08882",
                "Q03238","P51124","P49863","P49864","O35205","P20718","P11033",
                "P08884","P08883","P13366"
            ];
            ...
            let answer2 = answer2.iter().map(|x| format!("/fast/hyunbin/motif/swissprot_benchmark/swissprot_v4_foldcomp/AF-{}-F1-model_v4.pdb", x)).collect::<Vec<_>>();
            let metric = compare_target_answer( &str_result, &answer, &path_vec);
            let metric2 = compare_target_answer( &str_result, &answer2, &path_vec);
            let metric_vec = vec![metric, metric2];
