...
impl HashValue {
    ...
    pub fn perfect_hash(
        ...
        let h_cb_dist = discretize_value(cbd, 2.0, 20.0, 18.0);
        // Torsion angles
        let h_omega = discretize_value(omega, -180.0, 180.0, 16.0);
        let h_theta1 = discretize_value(theta1, -180.0, 180.0, 16.0);
        let h_theta2 = discretize_value(theta2, -180.0, 180.0, 16.0);
        // Planar angles
