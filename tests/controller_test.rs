...
fn test_index_builder() {
    ...
    controller.save_raw_feature("data/homeobox_hash_raw. tsv", false);
...
fn test_index_builder_2() {
    ...
    let index_table =
        index_builder.concat(&controller.numeric_id_vec, &controller.hash_collection_vec);
    let table_printer = IndexTablePrinter::Debug;
    controller.save_raw_feature("data/serine_hash_raw.tsv", false);
...
fn test_temp() {
    ...
    controller.save_raw_feature("analysis/result/msd_human_s1_hash_raw.tsv", false);
    let index_builder = IndexBuilder::new();
    let index_table =
        index_builder.concat(&controller.numeric_id_vec, &controller.hash_collection_vec);
    let table_printer = IndexTablePrinter::Debug;
